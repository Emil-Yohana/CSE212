...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: No else if statement to check to see if the turns is less than or equal to zero. This means that people with infinite turns will not be added back into the queue.
